...
- Release script now supports `current` and explicit stable version arguments, with clean-main, authenticated GitHub CLI, and free-tag preconditions. ([#4](https://github.com/kcosr/file-guardian/pull/4))
